...
public class TemplateHistoryResult extends org.apache.thrift.TUnion<TemplateHistoryResult, TemplateHistoryResult._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TemplateHistoryResult");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TemplateHistoryResult.class, metaDataMap);
  }

  public TemplateHistoryResult() {
    super();
  }

  public TemplateHistoryResult(_Fields setField, Object value) {
    super(setField, value);
  }

  public TemplateHistoryResult(TemplateHistoryResult other) {
    super(other);
  }
  public TemplateHistoryResult deepCopy() {
    return new TemplateHistoryResult(this);
  }

  public static TemplateHistoryResult template(JobTemplateModular value) {
    TemplateHistoryResult x = new TemplateHistoryResult();
    x.setTemplate(value);
    return x;
  }

  public static TemplateHistoryResult err(com.wi.director.thrift.v1.common.SystemException value) {
    TemplateHistoryResult x = new TemplateHistoryResult();
    x.setErr(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      case TEMPLATE:
        if (value instanceof JobTemplateModular) {
          break;
        }
        throw new ClassCastException("Was expecting value of type JobTemplateModular for field 'template', but got " + value.getClass().getSimpleName());
      case ERR:
      ...
      switch (setField) {
        case TEMPLATE:
          if (field.type == TEMPLATE_FIELD_DESC.type) {
            JobTemplateModular template;
            template = new JobTemplateModular();
            template.read(iprot);
            return template;
          } else {
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      case TEMPLATE:
        JobTemplateModular template = (JobTemplateModular)value_;
  ...
  public boolean equals(Object other) {
    if (other instanceof TemplateHistoryResult) {
      return equals((TemplateHistoryResult)other);
    } else {
      return false;
    }
  }

  public boolean equals(TemplateHistoryResult other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(TemplateHistoryResult other) {
