...
public class TemplateOrder implements org.apache.thrift.TBase<TemplateOrder, TemplateOrder._Fields>, java.io.Serializable, Cloneable, Comparable<TemplateOrder> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TemplateOrder");
  ...
  static {
    schemes.put(StandardScheme.class, new TemplateOrderStandardSchemeFactory());
  }
   ...
   * @see TemplateOrderBy
   */
  public TemplateOrderBy field; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FIELD, new org.apache.thrift.meta_data.FieldMetaData("field", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, TemplateOrderBy.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TemplateOrder.class, metaDataMap);
  }
   ...
   */
  public TemplateOrder(TemplateOrder other) {
  ...
  public TemplateOrder deepCopy() {
    return new TemplateOrder(this);
  }
   ...
   * @see TemplateOrderBy
   */
  public TemplateOrderBy getField() {
    return this.field;
  }
   ...
   * @see TemplateOrderBy
   */
  public TemplateOrder setField(TemplateOrderBy field) {
    this.field = field;
    return this;
  }
  ...
  public TemplateOrder setAsc(boolean asc) {
    this.asc = asc;
    setAscIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FIELD:
      if (value == null) {
        ...
        setField((TemplateOrderBy)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TemplateOrder)
      return this.equals((TemplateOrder)that);
    return false;
  }

  public boolean equals(TemplateOrder that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TemplateOrder other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TemplateOrder(");
    boolean first = true;
  ...
  private static class TemplateOrderStandardSchemeFactory implements SchemeFactory {
    public TemplateOrderStandardScheme getScheme() {
      return new TemplateOrderStandardScheme();
    }
  }

  private static class TemplateOrderStandardScheme extends StandardScheme<TemplateOrder> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TemplateOrder struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.field = com.wi.director.thrift.v1.jobtemplate.TemplateOrderBy.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TemplateOrder struct) throws org.apache.thrift.TException {
      struct.validate();
