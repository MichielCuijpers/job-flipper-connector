...
public class TeamRoleService {
  ...
  public interface Iface {
    ...
    public TeamRoleV2 create(String teamId, TeamRoleParams params) throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException;

    public TeamRoleV2 update(String roleId, TeamRoleParams params) throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException;

    public TeamRoleV2 get(String roleId) throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException;

    public List<TeamRoleV2> index(String teamId) throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException;

    public com.wi.director.thrift.v1.setting.SettingsForm getPermissionsSettings(String roleId) throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_create(String teamId, TeamRoleParams params) throws org.apache.thrift.TException
    {
    ...
    public TeamRoleV2 recv_create() throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException
    {
    ...
    public void send_update(String roleId, TeamRoleParams params) throws org.apache.thrift.TException
    {
    ...
    public TeamRoleV2 recv_update() throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException
    {
    ...
    public void send_get(String roleId) throws org.apache.thrift.TException
    {
    ...
    public TeamRoleV2 recv_get() throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException
    {
    ...
    public List<TeamRoleV2> recv_index() throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException
    {
    ...
    public com.wi.director.thrift.v1.setting.SettingsForm getPermissionsSettings(String roleId) throws com.wi.director.thrift.v1.common.SystemException, org.apache.thrift.TException
    {
      send_getPermissionsSettings(roleId);
      return recv_getPermissionsSettings();
    }

    public void send_getPermissionsSettings(String roleId) throws org.apache.thrift.TException
    {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class get<I extends Iface> extends org.apache.thrift.ProcessFunction<I, get_args> {
      ...
      public get_result getResult(I iface, get_args args) throws org.apache.thrift.TException {
        get_result result = new get_result();
        try {
          result.success = iface.get(args.roleId);
        } catch (com.wi.director.thrift.v1.common.SystemException err) {
          result.err = err;
        }
        return result;
    ...
    public static class getPermissionsSettings<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPermissionsSettings_args> {
      ...
      public getPermissionsSettings_result getResult(I iface, getPermissionsSettings_args args) throws org.apache.thrift.TException {
        getPermissionsSettings_result result = new getPermissionsSettings_result();
        try {
          result.success = iface.getPermissionsSettings(args.roleId);
        } catch (com.wi.director.thrift.v1.common.SystemException err) {
          result.err = err;
        }
        return result;
  ...
  public static class create_args implements org.apache.thrift.TBase<create_args, create_args._Fields>, java.io.Serializable, Cloneable, Comparable<create_args>   {
    ...
    public TeamRoleParams params; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.PARAMS, new org.apache.thrift.meta_data.FieldMetaData("params", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TeamRoleParams.class)));
    ...
    public create_args(create_args other) {
      ...
      if (other.isSetParams()) {
        this.params = new TeamRoleParams(other.params);
      }
    }
    ...
    public TeamRoleParams getParams() {
      return this.params;
    }

    public create_args setParams(TeamRoleParams params) {
      this.params = params;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case PARAMS:
        if (value == null) {
          ...
          setParams((TeamRoleParams)value);
        }
        break;
          ...
          switch (schemeField.id) {
            ...
            case 2: // PARAMS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.params = new TeamRoleParams();
  ...
  public static class create_result implements org.apache.thrift.TBase<create_result, create_result._Fields>, java.io.Serializable, Cloneable, Comparable<create_result>   {
    ...
    public TeamRoleV2 success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TeamRoleV2.class)));
    ...
    public create_result(create_result other) {
      if (other.isSetSuccess()) {
        this.success = new TeamRoleV2(other.success);
      }
      if (other.isSetErr()) {
    ...
    public TeamRoleV2 getSuccess() {
      return this.success;
    }

    public create_result setSuccess(TeamRoleV2 success) {
      this.success = success;
      return this;
    }
  ...
  public static class update_args implements org.apache.thrift.TBase<update_args, update_args._Fields>, java.io.Serializable, Cloneable, Comparable<update_args>   {
    ...
    public update_args setParams(TeamRoleParams params) {
      this.params = params;
      return this;
    }
  ...
  public static class update_result implements org.apache.thrift.TBase<update_result, update_result._Fields>, java.io.Serializable, Cloneable, Comparable<update_result>   {
    ...
    public update_result setSuccess(TeamRoleV2 success) {
      this.success = success;
      return this;
    }
  ...
  public static class get_result implements org.apache.thrift.TBase<get_result, get_result._Fields>, java.io.Serializable, Cloneable, Comparable<get_result>   {
    ...
    public get_result setSuccess(TeamRoleV2 success) {
      this.success = success;
      return this;
    }
  ...
  public static class index_result implements org.apache.thrift.TBase<index_result, index_result._Fields>, java.io.Serializable, Cloneable, Comparable<index_result>   {
    ...
    public List<TeamRoleV2> success; // required
    public com.wi.director.thrift.v1.common.SystemException err; // required
    ...
    public index_result(index_result other) {
      if (other.isSetSuccess()) {
        List<TeamRoleV2> __this__success = new ArrayList<TeamRoleV2>(other.success.size());
        for (TeamRoleV2 other_element : other.success) {
          __this__success.add(new TeamRoleV2(other_element));
        }
    ...
    public java.util.Iterator<TeamRoleV2> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(TeamRoleV2 elem) {
      if (this.success == null) {
        this.success = new ArrayList<TeamRoleV2>();
      }
      this.success.add(elem);
    }

    public List<TeamRoleV2> getSuccess() {
      return this.success;
    }

    public index_result setSuccess(List<TeamRoleV2> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<TeamRoleV2>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<TeamRoleV2>(_list0.size);
                  TeamRoleV2 _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new TeamRoleV2();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, index_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (TeamRoleV2 _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
  ...
  public static class getPermissionsSettings_args implements org.apache.thrift.TBase<getPermissionsSettings_args, getPermissionsSettings_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPermissionsSettings_args>   {
    ...
    public getPermissionsSettings_args setRoleId(String roleId) {
      this.roleId = roleId;
      return this;
    }
