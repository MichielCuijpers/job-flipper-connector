...
public class UserStats implements org.apache.thrift.TBase<UserStats, UserStats._Fields>, java.io.Serializable, Cloneable, Comparable<UserStats> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UserStats");
  ...
  static {
    schemes.put(StandardScheme.class, new UserStatsStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UserStats.class, metaDataMap);
  }
  ...
  public UserStats setCompletedJobs(int completedJobs) {
    this.completedJobs = completedJobs;
    setCompletedJobsIsSet(true);
    return this;
  }
  ...
  public UserStats setActiveJobs(int activeJobs) {
    this.activeJobs = activeJobs;
    setActiveJobsIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UserStats)
      return this.equals((UserStats)that);
    return false;
  }

  public boolean equals(UserStats that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserStats(");
    boolean first = true;
  ...
  private static class UserStatsStandardSchemeFactory implements SchemeFactory {
    public UserStatsStandardScheme getScheme() {
      return new UserStatsStandardScheme();
    }
  }

  private static class UserStatsStandardScheme extends StandardScheme<UserStats> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UserStats struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserStats struct) throws org.apache.thrift.TException {
      struct.validate();
