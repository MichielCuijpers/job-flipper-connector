...
public class JobRoleParams implements org.apache.thrift.TBase<JobRoleParams, JobRoleParams._Fields>, java.io.Serializable, Cloneable, Comparable<JobRoleParams> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("JobRoleParams");
  ...
  static {
    schemes.put(StandardScheme.class, new JobRoleParamsStandardSchemeFactory());
  }
  ...
  /**
   * Settings form for job role permissions. Get by calling settings#indexJobPermissions()
   */
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(JobRoleParams.class, metaDataMap);
  }

  public JobRoleParams() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public JobRoleParams(JobRoleParams other) {
    if (other.isSetName()) {
  ...
  public JobRoleParams deepCopy() {
    return new JobRoleParams(this);
  }
   ...
   * Name of the job role
   */
  public JobRoleParams setName(String name) {
    this.name = name;
    return this;
  }
   ...
   * Description of the job role
   */
  public JobRoleParams setDescrip(String descrip) {
   ...
   * Settings form for job role permissions. Get by calling settings#indexJobPermissions()
   */
  public JobRoleParams setPermissions(com.wi.director.thrift.v1.setting.SettingsForm permissions) {
   ...
   * Restrictions for this job role
   */
  public JobRoleParams setRestriction(JobRoleRestriction restriction) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof JobRoleParams)
      return this.equals((JobRoleParams)that);
    return false;
  }

  public boolean equals(JobRoleParams that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(JobRoleParams other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("JobRoleParams(");
    boolean first = true;
  ...
  private static class JobRoleParamsStandardSchemeFactory implements SchemeFactory {
    public JobRoleParamsStandardScheme getScheme() {
      return new JobRoleParamsStandardScheme();
    }
  }

  private static class JobRoleParamsStandardScheme extends StandardScheme<JobRoleParams> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, JobRoleParams struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobRoleParams struct) throws org.apache.thrift.TException {
      struct.validate();
