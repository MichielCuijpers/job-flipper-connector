...
public class DataSheetOrder implements org.apache.thrift.TBase<DataSheetOrder, DataSheetOrder._Fields>, java.io.Serializable, Cloneable, Comparable<DataSheetOrder> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DataSheetOrder");
  ...
  static {
    schemes.put(StandardScheme.class, new DataSheetOrderStandardSchemeFactory());
  }

  /**
   * 
   * @see DataSheetOrderBy
   */
  public DataSheetOrderBy field; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FIELD, new org.apache.thrift.meta_data.FieldMetaData("field", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, DataSheetOrderBy.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DataSheetOrder.class, metaDataMap);
  }

  public DataSheetOrder() {
    this.asc = true;

  }

  public DataSheetOrder(
    DataSheetOrderBy field,
    boolean asc)
  {
    this();
    this.field = field;
   ...
   */
  public DataSheetOrder(DataSheetOrder other) {
  ...
  public DataSheetOrder deepCopy() {
    return new DataSheetOrder(this);
  }
   ...
   * @see DataSheetOrderBy
   */
  public DataSheetOrderBy getField() {
    return this.field;
  }
   ...
   * @see DataSheetOrderBy
   */
  public DataSheetOrder setField(DataSheetOrderBy field) {
    this.field = field;
    return this;
  }
  ...
  public DataSheetOrder setAsc(boolean asc) {
    this.asc = asc;
    setAscIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FIELD:
      if (value == null) {
        ...
        setField((DataSheetOrderBy)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DataSheetOrder)
      return this.equals((DataSheetOrder)that);
    return false;
  }

  public boolean equals(DataSheetOrder that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DataSheetOrder other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DataSheetOrder(");
    boolean first = true;
  ...
  private static class DataSheetOrderStandardSchemeFactory implements SchemeFactory {
    public DataSheetOrderStandardScheme getScheme() {
      return new DataSheetOrderStandardScheme();
    }
  }

  private static class DataSheetOrderStandardScheme extends StandardScheme<DataSheetOrder> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DataSheetOrder struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.field = com.wi.director.thrift.v1.datasheet.DataSheetOrderBy.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataSheetOrder struct) throws org.apache.thrift.TException {
      struct.validate();
