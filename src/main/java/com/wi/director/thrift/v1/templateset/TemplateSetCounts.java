...
public class TemplateSetCounts implements org.apache.thrift.TBase<TemplateSetCounts, TemplateSetCounts._Fields>, java.io.Serializable, Cloneable, Comparable<TemplateSetCounts> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TemplateSetCounts");
  ...
  static {
    schemes.put(StandardScheme.class, new TemplateSetCountsStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TemplateSetCounts.class, metaDataMap);
  }

  public TemplateSetCounts() {
  }
   ...
   */
  public TemplateSetCounts(TemplateSetCounts other) {
    __isset_bitfield = other.__isset_bitfield;
    this.completedJobs = other.completedJobs;
    this.activeJobs = other.activeJobs;
  }

  public TemplateSetCounts deepCopy() {
    return new TemplateSetCounts(this);
  }
  ...
  public TemplateSetCounts setCompletedJobs(int completedJobs) {
    this.completedJobs = completedJobs;
    setCompletedJobsIsSet(true);
    return this;
  }
  ...
  public TemplateSetCounts setActiveJobs(int activeJobs) {
    this.activeJobs = activeJobs;
    setActiveJobsIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TemplateSetCounts)
      return this.equals((TemplateSetCounts)that);
    return false;
  }

  public boolean equals(TemplateSetCounts that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TemplateSetCounts other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TemplateSetCounts(");
    boolean first = true;
  ...
  private static class TemplateSetCountsStandardSchemeFactory implements SchemeFactory {
    public TemplateSetCountsStandardScheme getScheme() {
      return new TemplateSetCountsStandardScheme();
    }
  }

  private static class TemplateSetCountsStandardScheme extends StandardScheme<TemplateSetCounts> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TemplateSetCounts struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TemplateSetCounts struct) throws org.apache.thrift.TException {
      struct.validate();
