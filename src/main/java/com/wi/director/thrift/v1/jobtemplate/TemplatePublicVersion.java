...
public class TemplatePublicVersion implements org.apache.thrift.TBase<TemplatePublicVersion, TemplatePublicVersion._Fields>, java.io.Serializable, Cloneable, Comparable<TemplatePublicVersion> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TemplatePublicVersion");
  ...
  static {
    schemes.put(StandardScheme.class, new TemplatePublicVersionStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TemplatePublicVersion.class, metaDataMap);
  }

  public TemplatePublicVersion() {
  }
   ...
   */
  public TemplatePublicVersion(TemplatePublicVersion other) {
  ...
  public TemplatePublicVersion deepCopy() {
    return new TemplatePublicVersion(this);
  }
  ...
  public TemplatePublicVersion setJobTemplateId(String jobTemplateId) {
    this.jobTemplateId = jobTemplateId;
    return this;
  }
  ...
  public TemplatePublicVersion setPublicVersion(int publicVersion) {
    this.publicVersion = publicVersion;
    setPublicVersionIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TemplatePublicVersion)
      return this.equals((TemplatePublicVersion)that);
    return false;
  }

  public boolean equals(TemplatePublicVersion that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TemplatePublicVersion other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TemplatePublicVersion(");
    boolean first = true;
  ...
  private static class TemplatePublicVersionStandardSchemeFactory implements SchemeFactory {
    public TemplatePublicVersionStandardScheme getScheme() {
      return new TemplatePublicVersionStandardScheme();
    }
  }

  private static class TemplatePublicVersionStandardScheme extends StandardScheme<TemplatePublicVersion> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TemplatePublicVersion struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TemplatePublicVersion struct) throws org.apache.thrift.TException {
      struct.validate();
