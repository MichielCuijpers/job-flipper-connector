 ...
 */
public class JobFetchResult extends org.apache.thrift.TUnion<JobFetchResult, JobFetchResult._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("JobFetchResult");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(JobFetchResult.class, metaDataMap);
  }

  public JobFetchResult() {
    super();
  }

  public JobFetchResult(_Fields setField, Object value) {
    super(setField, value);
  }

  public JobFetchResult(JobFetchResult other) {
    super(other);
  }
  public JobFetchResult deepCopy() {
    return new JobFetchResult(this);
  }

  public static JobFetchResult job(JobModular value) {
    JobFetchResult x = new JobFetchResult();
    x.setJob(value);
    return x;
  }

  public static JobFetchResult err(com.wi.director.thrift.v1.common.SystemException value) {
    JobFetchResult x = new JobFetchResult();
    x.setErr(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      case JOB:
        if (value instanceof JobModular) {
          break;
        }
        throw new ClassCastException("Was expecting value of type JobModular for field 'job', but got " + value.getClass().getSimpleName());
      case ERR:
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      case JOB:
        JobModular job = (JobModular)value_;
        job.write(oprot);
        return;
      case ERR:
  ...
  public boolean equals(Object other) {
    if (other instanceof JobFetchResult) {
      return equals((JobFetchResult)other);
    } else {
      return false;
    }
  }

  public boolean equals(JobFetchResult other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(JobFetchResult other) {
