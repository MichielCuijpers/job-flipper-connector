...
public class SettingChangeOrder implements org.apache.thrift.TBase<SettingChangeOrder, SettingChangeOrder._Fields>, java.io.Serializable, Cloneable, Comparable<SettingChangeOrder> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SettingChangeOrder");
  ...
  static {
    schemes.put(StandardScheme.class, new SettingChangeOrderStandardSchemeFactory());
  }

  /**
   * 
   * @see SettingChangeOrderBy
   */
  public SettingChangeOrderBy field; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FIELD, new org.apache.thrift.meta_data.FieldMetaData("field", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, SettingChangeOrderBy.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SettingChangeOrder.class, metaDataMap);
  }

  public SettingChangeOrder() {
    this.asc = true;

  }

  public SettingChangeOrder(
    SettingChangeOrderBy field,
    boolean asc)
  {
    this();
    this.field = field;
   ...
   */
  public SettingChangeOrder(SettingChangeOrder other) {
  ...
  public SettingChangeOrder deepCopy() {
    return new SettingChangeOrder(this);
  }
   ...
   * @see SettingChangeOrderBy
   */
  public SettingChangeOrderBy getField() {
    return this.field;
  }
   ...
   * @see SettingChangeOrderBy
   */
  public SettingChangeOrder setField(SettingChangeOrderBy field) {
    this.field = field;
    return this;
  }
  ...
  public SettingChangeOrder setAsc(boolean asc) {
    this.asc = asc;
    setAscIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FIELD:
      if (value == null) {
        ...
        setField((SettingChangeOrderBy)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SettingChangeOrder)
      return this.equals((SettingChangeOrder)that);
    return false;
  }

  public boolean equals(SettingChangeOrder that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SettingChangeOrder other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SettingChangeOrder(");
    boolean first = true;
  ...
  private static class SettingChangeOrderStandardSchemeFactory implements SchemeFactory {
    public SettingChangeOrderStandardScheme getScheme() {
      return new SettingChangeOrderStandardScheme();
    }
  }

  private static class SettingChangeOrderStandardScheme extends StandardScheme<SettingChangeOrder> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SettingChangeOrder struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.field = com.wi.director.thrift.v1.setting.SettingChangeOrderBy.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SettingChangeOrder struct) throws org.apache.thrift.TException {
      struct.validate();
