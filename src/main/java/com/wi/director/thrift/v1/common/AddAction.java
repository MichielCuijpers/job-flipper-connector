...
public class AddAction implements org.apache.thrift.TBase<AddAction, AddAction._Fields>, java.io.Serializable, Cloneable, Comparable<AddAction> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddAction");
  ...
  static {
    schemes.put(StandardScheme.class, new AddActionStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddAction.class, metaDataMap);
  }
   ...
   */
  public AddAction(AddAction other) {
  ...
  public AddAction setId(String id) {
    this.id = id;
    return this;
  }
  ...
  public AddAction setPosition(int position) {
    this.position = position;
    setPositionIsSet(true);
    return this;
  }
   ...
   * For <code>AddAction</code> to attach the selected data sheet set id -> data sheet id for templates with data sheet definition references, which is a requirement for reference resolution
   */
  public AddAction setExtraInfo(Map<String,String> extraInfo) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddAction)
      return this.equals((AddAction)that);
    return false;
  }

  public boolean equals(AddAction that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddAction(");
    boolean first = true;
  ...
  private static class AddActionStandardSchemeFactory implements SchemeFactory {
    public AddActionStandardScheme getScheme() {
      return new AddActionStandardScheme();
    }
  }

  private static class AddActionStandardScheme extends StandardScheme<AddAction> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddAction struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extraInfo = new HashMap<String,String>(2*_map9.size);
                String _key10;
                String _val11;
                for (int _i12 = 0; _i12 < _map9.size; ++_i12)
                {
                  ...
                  struct.extraInfo.put(_key10, _val11);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddAction struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.extraInfo != null) {
        if (struct.isSetExtraInfo()) {
          oprot.writeFieldBegin(EXTRA_INFO_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter13 : struct.extraInfo.entrySet())
            {
