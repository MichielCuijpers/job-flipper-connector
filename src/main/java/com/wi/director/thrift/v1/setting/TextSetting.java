...
public class TextSetting implements org.apache.thrift.TBase<TextSetting, TextSetting._Fields>, java.io.Serializable, Cloneable, Comparable<TextSetting> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TextSetting");
  ...
  static {
    schemes.put(StandardScheme.class, new TextSettingStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TextSetting.class, metaDataMap);
  }
   ...
   */
  public TextSetting(TextSetting other) {
   ...
   * the order in which to display the settings. Read only
   */
  public TextSetting setIndex(int index) {
    this.index = index;
    setIndexIsSet(true);
    return this;
  }
  ...
  public TextSetting setTitle(String title) {
    this.title = title;
    return this;
  }
  ...
  public TextSetting setDescrip(String descrip) {
    this.descrip = descrip;
    return this;
  }
   ...
   * input value, set to null for no update
   */
  public TextSetting setValue(String value) {
    this.value = value;
    return this;
  }
  ...
  public TextSetting setId(String id) {
    this.id = id;
    return this;
  }
   ...
   * be set by server ever. If set it will ignore the value of "value"
   */
  public TextSetting setDeleteValue(boolean deleteValue) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TextSetting)
      return this.equals((TextSetting)that);
    return false;
  }

  public boolean equals(TextSetting that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TextSetting other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TextSetting(");
    boolean first = true;
  ...
  private static class TextSettingStandardSchemeFactory implements SchemeFactory {
    public TextSettingStandardScheme getScheme() {
      return new TextSettingStandardScheme();
    }
  }

  private static class TextSettingStandardScheme extends StandardScheme<TextSetting> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TextSetting struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TextSetting struct) throws org.apache.thrift.TException {
      struct.validate();
