...
public class UserQueryResult implements org.apache.thrift.TBase<UserQueryResult, UserQueryResult._Fields>, java.io.Serializable, Cloneable, Comparable<UserQueryResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UserQueryResult");
  ...
  static {
    schemes.put(StandardScheme.class, new UserQueryResultStandardSchemeFactory());
  }

  public List<UserModular> users; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UserQueryResult.class, metaDataMap);
  }
   ...
   */
  public UserQueryResult(UserQueryResult other) {
    if (other.isSetUsers()) {
      List<UserModular> __this__users = new ArrayList<UserModular>(other.users.size());
      for (UserModular other_element : other.users) {
        __this__users.add(new UserModular(other_element));
      }
  ...
  public UserQueryResult deepCopy() {
  ...
  public java.util.Iterator<UserModular> getUsersIterator() {
    return (this.users == null) ? null : this.users.iterator();
  }

  public void addToUsers(UserModular elem) {
    if (this.users == null) {
      this.users = new ArrayList<UserModular>();
    }
    this.users.add(elem);
  }

  public List<UserModular> getUsers() {
    return this.users;
  }

  public UserQueryResult setUsers(List<UserModular> users) {
    this.users = users;
    return this;
  }
  ...
  public UserQueryResult setPageInfo(com.wi.director.thrift.v1.common.PageInfo pageInfo) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case USERS:
      if (value == null) {
        ...
        setUsers((List<UserModular>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UserQueryResult)
      return this.equals((UserQueryResult)that);
    return false;
  }

  public boolean equals(UserQueryResult that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(UserQueryResult other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserQueryResult(");
    boolean first = true;
  ...
  private static class UserQueryResultStandardSchemeFactory implements SchemeFactory {
    public UserQueryResultStandardScheme getScheme() {
      return new UserQueryResultStandardScheme();
    }
  }

  private static class UserQueryResultStandardScheme extends StandardScheme<UserQueryResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UserQueryResult struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new ArrayList<UserModular>(_list27.size);
                UserModular _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new UserModular();
                  _elem28.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserQueryResult struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.users != null) {
        oprot.writeFieldBegin(USERS_FIELD_DESC);
        {
          ...
          for (UserModular _iter30 : struct.users)
          {
            _iter30.write(oprot);
          }
          oprot.writeListEnd();
