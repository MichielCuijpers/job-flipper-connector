...
public class DataSheetSetOptions implements org.apache.thrift.TBase<DataSheetSetOptions, DataSheetSetOptions._Fields>, java.io.Serializable, Cloneable, Comparable<DataSheetSetOptions> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DataSheetSetOptions");
  ...
  private static final org.apache.thrift.protocol.TField LAST_UPDATED_AT_FIELD_DESC = new org.apache.thrift.protocol.TField("lastUpdatedAt", org.apache.thrift.protocol.TType.I64, (short)3);
  ...
  static {
    schemes.put(StandardScheme.class, new DataSheetSetOptionsStandardSchemeFactory());
  }
   ...
   */
  public List<DataSheetSetOrder> order; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * Only get sets modified after this timestamp
     */
    LAST_UPDATED_AT((short)3, "lastUpdatedAt"),
    /**
     * Search for sets that contain this title
     */
    TITLE((short)4, "title"),
  ...
  private static final int __LASTUPDATEDAT_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.SHOW_ARCHIVED,_Fields.ONLY_ARCHIVED,_Fields.LAST_UPDATED_AT,_Fields.TITLE,_Fields.PAGE_REQ,_Fields.ORDER};
  ...
  static {
    ...
    tmpMap.put(_Fields.ORDER, new org.apache.thrift.meta_data.FieldMetaData("order", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DataSheetSetOrder.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DataSheetSetOptions.class, metaDataMap);
  }

  public DataSheetSetOptions() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public DataSheetSetOptions(DataSheetSetOptions other) {
    ...
    if (other.isSetOrder()) {
      List<DataSheetSetOrder> __this__order = new ArrayList<DataSheetSetOrder>(other.order.size());
      for (DataSheetSetOrder other_element : other.order) {
        __this__order.add(new DataSheetSetOrder(other_element));
      }
      this.order = __this__order;
    }
  }

  public DataSheetSetOptions deepCopy() {
    return new DataSheetSetOptions(this);
  }
   ...
   * Default to active sets only
   */
  public DataSheetSetOptions setShowArchived(boolean showArchived) {
   ...
   * Show only the archived sets
   */
  public DataSheetSetOptions setOnlyArchived(boolean onlyArchived) {
   ...
   * Only get sets modified after this timestamp
   */
  public DataSheetSetOptions setLastUpdatedAt(long lastUpdatedAt) {
   ...
   * Search for sets that contain this title
   */
  public DataSheetSetOptions setTitle(String title) {
    this.title = title;
    return this;
  }
  ...
  public DataSheetSetOptions setPageReq(com.wi.director.thrift.v1.common.PageReq pageReq) {
  ...
  public java.util.Iterator<DataSheetSetOrder> getOrderIterator() {
    return (this.order == null) ? null : this.order.iterator();
  }

  public void addToOrder(DataSheetSetOrder elem) {
    if (this.order == null) {
      this.order = new ArrayList<DataSheetSetOrder>();
    }
    this.order.add(elem);
  }
   ...
   * Default is by most recent edit
   */
  public List<DataSheetSetOrder> getOrder() {
    return this.order;
  }
   ...
   * Default is by most recent edit
   */
  public DataSheetSetOptions setOrder(List<DataSheetSetOrder> order) {
    this.order = order;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ORDER:
      if (value == null) {
        ...
        setOrder((List<DataSheetSetOrder>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DataSheetSetOptions)
      return this.equals((DataSheetSetOptions)that);
    return false;
  }

  public boolean equals(DataSheetSetOptions that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DataSheetSetOptions other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DataSheetSetOptions(");
    boolean first = true;
  ...
  private static class DataSheetSetOptionsStandardSchemeFactory implements SchemeFactory {
    public DataSheetSetOptionsStandardScheme getScheme() {
      return new DataSheetSetOptionsStandardScheme();
    }
  }

  private static class DataSheetSetOptionsStandardScheme extends StandardScheme<DataSheetSetOptions> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DataSheetSetOptions struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.order = new ArrayList<DataSheetSetOrder>(_list22.size);
                DataSheetSetOrder _elem23;
                for (int _i24 = 0; _i24 < _list22.size; ++_i24)
                {
                  _elem23 = new DataSheetSetOrder();
                  _elem23.read(iprot);
                  struct.order.add(_elem23);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataSheetSetOptions struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.order != null) {
        if (struct.isSetOrder()) {
          oprot.writeFieldBegin(ORDER_FIELD_DESC);
          {
            ...
            for (DataSheetSetOrder _iter25 : struct.order)
            {
              _iter25.write(oprot);
            }
            oprot.writeListEnd();
