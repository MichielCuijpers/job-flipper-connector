...
public class TemplateFetchResult extends org.apache.thrift.TUnion<TemplateFetchResult, TemplateFetchResult._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TemplateFetchResult");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TemplateFetchResult.class, metaDataMap);
  }

  public TemplateFetchResult() {
    super();
  }

  public TemplateFetchResult(_Fields setField, Object value) {
    super(setField, value);
  }

  public TemplateFetchResult(TemplateFetchResult other) {
    super(other);
  }
  public TemplateFetchResult deepCopy() {
    return new TemplateFetchResult(this);
  }

  public static TemplateFetchResult template(JobTemplateModular value) {
    TemplateFetchResult x = new TemplateFetchResult();
    x.setTemplate(value);
    return x;
  }

  public static TemplateFetchResult err(com.wi.director.thrift.v1.common.SystemException value) {
    TemplateFetchResult x = new TemplateFetchResult();
    x.setErr(value);
    return x;
  }
  ...
  public boolean equals(Object other) {
    if (other instanceof TemplateFetchResult) {
      return equals((TemplateFetchResult)other);
    } else {
      return false;
    }
  }

  public boolean equals(TemplateFetchResult other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(TemplateFetchResult other) {
