...
public class JobOrder implements org.apache.thrift.TBase<JobOrder, JobOrder._Fields>, java.io.Serializable, Cloneable, Comparable<JobOrder> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("JobOrder");
  ...
  static {
    schemes.put(StandardScheme.class, new JobOrderStandardSchemeFactory());
  }
   ...
   * @see JobOrderBy
   */
  public JobOrderBy field; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FIELD, new org.apache.thrift.meta_data.FieldMetaData("field", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, JobOrderBy.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(JobOrder.class, metaDataMap);
  }
   ...
   */
  public JobOrder(JobOrder other) {
  ...
  public JobOrder deepCopy() {
    return new JobOrder(this);
  }
   ...
   * @see JobOrderBy
   */
  public JobOrder setField(JobOrderBy field) {
    this.field = field;
    return this;
  }
  ...
  public JobOrder setAsc(boolean asc) {
    this.asc = asc;
    setAscIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof JobOrder)
      return this.equals((JobOrder)that);
    return false;
  }

  public boolean equals(JobOrder that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(JobOrder other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("JobOrder(");
    boolean first = true;
  ...
  private static class JobOrderStandardSchemeFactory implements SchemeFactory {
    public JobOrderStandardScheme getScheme() {
      return new JobOrderStandardScheme();
    }
  }

  private static class JobOrderStandardScheme extends StandardScheme<JobOrder> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, JobOrder struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.field = com.wi.director.thrift.v1.job.JobOrderBy.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobOrder struct) throws org.apache.thrift.TException {
      struct.validate();
