...
public class TimeIncrement implements org.apache.thrift.TBase<TimeIncrement, TimeIncrement._Fields>, java.io.Serializable, Cloneable, Comparable<TimeIncrement> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TimeIncrement");
  ...
  static {
    schemes.put(StandardScheme.class, new TimeIncrementStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TimeIncrement.class, metaDataMap);
  }

  public TimeIncrement() {
    this.unit = com.parsable.thrift.v1.analytics.TimeUnit.DAY;
   ...
   */
  public TimeIncrement(TimeIncrement other) {
  ...
  public TimeIncrement deepCopy() {
    return new TimeIncrement(this);
  }
   ...
   * @see TimeUnit
   */
  public TimeIncrement setUnit(TimeUnit unit) {
    this.unit = unit;
    return this;
  }
  ...
  public TimeIncrement setCount(int count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TimeIncrement)
      return this.equals((TimeIncrement)that);
    return false;
  }

  public boolean equals(TimeIncrement that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TimeIncrement other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TimeIncrement(");
    boolean first = true;
  ...
  private static class TimeIncrementStandardSchemeFactory implements SchemeFactory {
    public TimeIncrementStandardScheme getScheme() {
      return new TimeIncrementStandardScheme();
    }
  }

  private static class TimeIncrementStandardScheme extends StandardScheme<TimeIncrement> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TimeIncrement struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // UNIT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.unit = com.parsable.thrift.v1.analytics.TimeUnit.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TimeIncrement struct) throws org.apache.thrift.TException {
      struct.validate();
