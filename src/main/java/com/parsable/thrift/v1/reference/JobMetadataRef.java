...
public class JobMetadataRef implements org.apache.thrift.TBase<JobMetadataRef, JobMetadataRef._Fields>, java.io.Serializable, Cloneable, Comparable<JobMetadataRef> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("JobMetadataRef");
  ...
  static {
    schemes.put(StandardScheme.class, new JobMetadataRefStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(JobMetadataRef.class, metaDataMap);
  }

  public JobMetadataRef() {
  }
   ...
   */
  public JobMetadataRef(JobMetadataRef other) {
  ...
  public JobMetadataRef deepCopy() {
    return new JobMetadataRef(this);
  }
  ...
  public JobMetadataRef setMetadataId(String metadataId) {
    this.metadataId = metadataId;
    return this;
  }
  ...
  public JobMetadataRef setKey(String key) {
    this.key = key;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof JobMetadataRef)
      return this.equals((JobMetadataRef)that);
    return false;
  }

  public boolean equals(JobMetadataRef that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(JobMetadataRef other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("JobMetadataRef(");
    boolean first = true;
  ...
  private static class JobMetadataRefStandardSchemeFactory implements SchemeFactory {
    public JobMetadataRefStandardScheme getScheme() {
      return new JobMetadataRefStandardScheme();
    }
  }

  private static class JobMetadataRefStandardScheme extends StandardScheme<JobMetadataRef> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, JobMetadataRef struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobMetadataRef struct) throws org.apache.thrift.TException {
      struct.validate();
