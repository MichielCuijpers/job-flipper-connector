...
public class PublishOp implements org.apache.thrift.TBase<PublishOp, PublishOp._Fields>, java.io.Serializable, Cloneable, Comparable<PublishOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PublishOp");

  private static final org.apache.thrift.protocol.TField PUBLIC_VERSION_FIELD_DESC = new org.apache.thrift.protocol.TField("publicVersion", org.apache.thrift.protocol.TType.I32, (short)1);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new PublishOpStandardSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    PUBLIC_VERSION((short)1, "publicVersion");
  ...
  private static final _Fields optionals[] = {_Fields.PUBLIC_VERSION};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PublishOp.class, metaDataMap);
  }
   ...
   */
  public PublishOp(PublishOp other) {
    __isset_bitfield = other.__isset_bitfield;
    this.publicVersion = other.publicVersion;
  }

  public PublishOp deepCopy() {
  ...
  public PublishOp setPublicVersion(int publicVersion) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PublishOp)
      return this.equals((PublishOp)that);
    return false;
  }

  public boolean equals(PublishOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PublishOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PublishOp(");
    boolean first = true;
  ...
  private static class PublishOpStandardSchemeFactory implements SchemeFactory {
    public PublishOpStandardScheme getScheme() {
      return new PublishOpStandardScheme();
    }
  }

  private static class PublishOpStandardScheme extends StandardScheme<PublishOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PublishOp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PublishOp struct) throws org.apache.thrift.TException {
      struct.validate();
