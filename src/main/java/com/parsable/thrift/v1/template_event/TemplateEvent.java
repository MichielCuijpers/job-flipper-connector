...
public class TemplateEvent implements org.apache.thrift.TBase<TemplateEvent, TemplateEvent._Fields>, java.io.Serializable, Cloneable, Comparable<TemplateEvent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TemplateEvent");
  ...
  static {
    schemes.put(StandardScheme.class, new TemplateEventStandardSchemeFactory());
  }

  public String templateId; // required
  public com.parsable.thrift.v1.core_event.Pedigree pedigree; // required
  public TemplateOp op; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.OP, new org.apache.thrift.meta_data.FieldMetaData("op", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TemplateOp.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TemplateEvent.class, metaDataMap);
  }
   ...
   */
  public TemplateEvent(TemplateEvent other) {
    ...
    if (other.isSetOp()) {
      this.op = new TemplateOp(other.op);
    }
  ...
  public TemplateEvent deepCopy() {
    return new TemplateEvent(this);
  }
  ...
  public TemplateEvent setTemplateId(String templateId) {
    this.templateId = templateId;
    return this;
  }
  ...
  public TemplateEvent setPedigree(com.parsable.thrift.v1.core_event.Pedigree pedigree) {
    this.pedigree = pedigree;
    return this;
  }
  ...
  public TemplateOp getOp() {
    return this.op;
  }

  public TemplateEvent setOp(TemplateOp op) {
    this.op = op;
    return this;
  }
  ...
  public TemplateEvent setInternalVersion(int internalVersion) {
  ...
  public TemplateEvent setPublicVersion(int publicVersion) {
  ...
  public TemplateEvent setPublishedVersion(int publishedVersion) {
  ...
  public TemplateEvent setNewInternalVersion(int newInternalVersion) {
  ...
  public TemplateEvent setNewPublicVersion(int newPublicVersion) {
  ...
  public TemplateEvent setNewPublishedVersion(int newPublishedVersion) {
  ...
  public TemplateEvent setTemplate(com.wi.director.thrift.v1.jobtemplate.JobTemplateModular template) {
  ...
  public TemplateEvent setReceivedAt(long receivedAt) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TemplateEvent)
      return this.equals((TemplateEvent)that);
    return false;
  }

  public boolean equals(TemplateEvent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TemplateEvent other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TemplateEvent(");
    boolean first = true;
  ...
  private static class TemplateEventStandardSchemeFactory implements SchemeFactory {
    public TemplateEventStandardScheme getScheme() {
      return new TemplateEventStandardScheme();
    }
  }

  private static class TemplateEventStandardScheme extends StandardScheme<TemplateEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TemplateEvent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TemplateEvent struct) throws org.apache.thrift.TException {
      struct.validate();
