...
public class TagDeleteOp implements org.apache.thrift.TBase<TagDeleteOp, TagDeleteOp._Fields>, java.io.Serializable, Cloneable, Comparable<TagDeleteOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TagDeleteOp");
  ...
  static {
    schemes.put(StandardScheme.class, new TagDeleteOpStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TagDeleteOp.class, metaDataMap);
  }
   ...
   */
  public TagDeleteOp(TagDeleteOp other) {
    if (other.isSetTagId()) {
      this.tagId = other.tagId;
    }
  }

  public TagDeleteOp deepCopy() {
    return new TagDeleteOp(this);
  }
  ...
  public TagDeleteOp setTagId(String tagId) {
    this.tagId = tagId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TagDeleteOp)
      return this.equals((TagDeleteOp)that);
    return false;
  }

  public boolean equals(TagDeleteOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TagDeleteOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TagDeleteOp(");
    boolean first = true;
  ...
  private static class TagDeleteOpStandardSchemeFactory implements SchemeFactory {
    public TagDeleteOpStandardScheme getScheme() {
      return new TagDeleteOpStandardScheme();
    }
  }

  private static class TagDeleteOpStandardScheme extends StandardScheme<TagDeleteOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TagDeleteOp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TagDeleteOp struct) throws org.apache.thrift.TException {
      struct.validate();
