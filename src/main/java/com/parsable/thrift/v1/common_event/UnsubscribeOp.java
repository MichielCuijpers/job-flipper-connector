...
public class UnsubscribeOp implements org.apache.thrift.TBase<UnsubscribeOp, UnsubscribeOp._Fields>, java.io.Serializable, Cloneable, Comparable<UnsubscribeOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UnsubscribeOp");
  ...
  static {
    schemes.put(StandardScheme.class, new UnsubscribeOpStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UnsubscribeOp.class, metaDataMap);
  }

  public UnsubscribeOp() {
  }
  ...
  public UnsubscribeOp setSubscriber(com.parsable.thrift.v1.core_event.Subscriber subscriber) {
    this.subscriber = subscriber;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UnsubscribeOp)
      return this.equals((UnsubscribeOp)that);
    return false;
  }

  public boolean equals(UnsubscribeOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(UnsubscribeOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UnsubscribeOp(");
    boolean first = true;
  ...
  private static class UnsubscribeOpStandardSchemeFactory implements SchemeFactory {
    public UnsubscribeOpStandardScheme getScheme() {
      return new UnsubscribeOpStandardScheme();
    }
  }

  private static class UnsubscribeOpStandardScheme extends StandardScheme<UnsubscribeOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UnsubscribeOp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UnsubscribeOp struct) throws org.apache.thrift.TException {
      struct.validate();
