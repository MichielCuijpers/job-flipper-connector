...
public class StepGroupEnterOp implements org.apache.thrift.TBase<StepGroupEnterOp, StepGroupEnterOp._Fields>, java.io.Serializable, Cloneable, Comparable<StepGroupEnterOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StepGroupEnterOp");
  ...
  static {
    schemes.put(StandardScheme.class, new StepGroupEnterOpStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StepGroupEnterOp.class, metaDataMap);
  }

  public StepGroupEnterOp() {
  }
   ...
   */
  public StepGroupEnterOp(StepGroupEnterOp other) {
  ...
  public StepGroupEnterOp deepCopy() {
    return new StepGroupEnterOp(this);
  }
  ...
  public StepGroupEnterOp setJobStepGroupId(String jobStepGroupId) {
    this.jobStepGroupId = jobStepGroupId;
    return this;
  }
  ...
  public StepGroupEnterOp setStepGroupId(String stepGroupId) {
  ...
  public StepGroupEnterOp setIsEntered(boolean isEntered) {
    this.isEntered = isEntered;
    setIsEnteredIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StepGroupEnterOp)
      return this.equals((StepGroupEnterOp)that);
    return false;
  }

  public boolean equals(StepGroupEnterOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StepGroupEnterOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StepGroupEnterOp(");
    boolean first = true;
  ...
  private static class StepGroupEnterOpStandardSchemeFactory implements SchemeFactory {
    public StepGroupEnterOpStandardScheme getScheme() {
      return new StepGroupEnterOpStandardScheme();
    }
  }

  private static class StepGroupEnterOpStandardScheme extends StandardScheme<StepGroupEnterOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StepGroupEnterOp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StepGroupEnterOp struct) throws org.apache.thrift.TException {
      struct.validate();
