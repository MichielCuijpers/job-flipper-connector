...
public class JobAnalyticsEvent implements org.apache.thrift.TBase<JobAnalyticsEvent, JobAnalyticsEvent._Fields>, java.io.Serializable, Cloneable, Comparable<JobAnalyticsEvent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("JobAnalyticsEvent");
  ...
  static {
    schemes.put(StandardScheme.class, new JobAnalyticsEventStandardSchemeFactory());
  }

  public String jobId; // required
  public com.parsable.thrift.v1.core_event.Pedigree pedigree; // required
  public JobAnalyticsOp op; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.OP, new org.apache.thrift.meta_data.FieldMetaData("op", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, JobAnalyticsOp.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(JobAnalyticsEvent.class, metaDataMap);
  }

  public JobAnalyticsEvent() {
  }
   ...
   */
  public JobAnalyticsEvent(JobAnalyticsEvent other) {
    ...
    if (other.isSetOp()) {
      this.op = new JobAnalyticsOp(other.op);
    }
    this.receivedAt = other.receivedAt;
  }

  public JobAnalyticsEvent deepCopy() {
    return new JobAnalyticsEvent(this);
  }
  ...
  public JobAnalyticsEvent setJobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public JobAnalyticsEvent setPedigree(com.parsable.thrift.v1.core_event.Pedigree pedigree) {
    this.pedigree = pedigree;
    return this;
  }
  ...
  public JobAnalyticsOp getOp() {
    return this.op;
  }

  public JobAnalyticsEvent setOp(JobAnalyticsOp op) {
    this.op = op;
    return this;
  }
  ...
  public JobAnalyticsEvent setReceivedAt(long receivedAt) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof JobAnalyticsEvent)
      return this.equals((JobAnalyticsEvent)that);
    return false;
  }

  public boolean equals(JobAnalyticsEvent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(JobAnalyticsEvent other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("JobAnalyticsEvent(");
    boolean first = true;
  ...
  private static class JobAnalyticsEventStandardSchemeFactory implements SchemeFactory {
    public JobAnalyticsEventStandardScheme getScheme() {
      return new JobAnalyticsEventStandardScheme();
    }
  }

  private static class JobAnalyticsEventStandardScheme extends StandardScheme<JobAnalyticsEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, JobAnalyticsEvent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobAnalyticsEvent struct) throws org.apache.thrift.TException {
      struct.validate();
