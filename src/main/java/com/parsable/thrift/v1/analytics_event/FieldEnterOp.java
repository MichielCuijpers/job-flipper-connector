...
public class FieldEnterOp implements org.apache.thrift.TBase<FieldEnterOp, FieldEnterOp._Fields>, java.io.Serializable, Cloneable, Comparable<FieldEnterOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FieldEnterOp");
  ...
  private static final org.apache.thrift.protocol.TField IS_ENTERED_FIELD_DESC = new org.apache.thrift.protocol.TField("isEntered", org.apache.thrift.protocol.TType.BOOL, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new FieldEnterOpStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FieldEnterOp.class, metaDataMap);
  }
   ...
   */
  public FieldEnterOp(FieldEnterOp other) {
  ...
  public FieldEnterOp deepCopy() {
    return new FieldEnterOp(this);
  }
  ...
  public FieldEnterOp setJobStepId(String jobStepId) {
    this.jobStepId = jobStepId;
    return this;
  }
  ...
  public FieldEnterOp setStepId(String stepId) {
    this.stepId = stepId;
    return this;
  }
  ...
  public FieldEnterOp setFieldId(String fieldId) {
    this.fieldId = fieldId;
    return this;
  }
  ...
  public FieldEnterOp setIsEntered(boolean isEntered) {
    this.isEntered = isEntered;
    setIsEnteredIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FieldEnterOp)
      return this.equals((FieldEnterOp)that);
    return false;
  }

  public boolean equals(FieldEnterOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FieldEnterOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FieldEnterOp(");
    boolean first = true;
  ...
  private static class FieldEnterOpStandardSchemeFactory implements SchemeFactory {
    public FieldEnterOpStandardScheme getScheme() {
      return new FieldEnterOpStandardScheme();
    }
  }

  private static class FieldEnterOpStandardScheme extends StandardScheme<FieldEnterOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FieldEnterOp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FieldEnterOp struct) throws org.apache.thrift.TException {
      struct.validate();
