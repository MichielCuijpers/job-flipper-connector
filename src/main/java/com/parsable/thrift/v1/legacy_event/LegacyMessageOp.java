...
public class LegacyMessageOp implements org.apache.thrift.TBase<LegacyMessageOp, LegacyMessageOp._Fields>, java.io.Serializable, Cloneable, Comparable<LegacyMessageOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("LegacyMessageOp");
  ...
  static {
    schemes.put(StandardScheme.class, new LegacyMessageOpStandardSchemeFactory());
  }
   ...
   */
  public com.wi.director.thrift.v1.messaging.MessageCategory category; // optional
  ...
  private static final _Fields optionals[] = {_Fields.STRUCTURED_BODY,_Fields.CATEGORY,_Fields.DOCUMENTS,_Fields.UPDATED_SEQ_ID,_Fields.MESSAGE_ID};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(LegacyMessageOp.class, metaDataMap);
  }

  public LegacyMessageOp() {
  }
   ...
   */
  public LegacyMessageOp(LegacyMessageOp other) {
  ...
  public LegacyMessageOp deepCopy() {
    return new LegacyMessageOp(this);
  }
  ...
  public LegacyMessageOp setBody(String body) {
    this.body = body;
    return this;
  }
  ...
  public LegacyMessageOp setStructuredBody(com.wi.director.thrift.v1.messaging.StructuredBody structuredBody) {
   ...
   * @see com.wi.director.thrift.v1.messaging.MessageCategory
   */
  public LegacyMessageOp setCategory(com.wi.director.thrift.v1.messaging.MessageCategory category) {
  ...
  public LegacyMessageOp setDocuments(List<com.wi.director.thrift.v1.document.Document> documents) {
  ...
  public LegacyMessageOp setUpdatedSeqId(long updatedSeqId) {
  ...
  public LegacyMessageOp setMessageId(String messageId) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof LegacyMessageOp)
      return this.equals((LegacyMessageOp)that);
    return false;
  }

  public boolean equals(LegacyMessageOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(LegacyMessageOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LegacyMessageOp(");
    boolean first = true;
  ...
  private static class LegacyMessageOpStandardSchemeFactory implements SchemeFactory {
    public LegacyMessageOpStandardScheme getScheme() {
      return new LegacyMessageOpStandardScheme();
    }
  }

  private static class LegacyMessageOpStandardScheme extends StandardScheme<LegacyMessageOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, LegacyMessageOp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.documents = new ArrayList<com.wi.director.thrift.v1.document.Document>(_list12.size);
                com.wi.director.thrift.v1.document.Document _elem13;
                for (int _i14 = 0; _i14 < _list12.size; ++_i14)
                {
                  _elem13 = new com.wi.director.thrift.v1.document.Document();
                  _elem13.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LegacyMessageOp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.documents != null) {
        if (struct.isSetDocuments()) {
          oprot.writeFieldBegin(DOCUMENTS_FIELD_DESC);
          {
            ...
            for (com.wi.director.thrift.v1.document.Document _iter15 : struct.documents)
            {
              _iter15.write(oprot);
            }
            oprot.writeListEnd();
