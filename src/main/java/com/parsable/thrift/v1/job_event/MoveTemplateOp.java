...
public class MoveTemplateOp implements org.apache.thrift.TBase<MoveTemplateOp, MoveTemplateOp._Fields>, java.io.Serializable, Cloneable, Comparable<MoveTemplateOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MoveTemplateOp");
  ...
  static {
    schemes.put(StandardScheme.class, new MoveTemplateOpStandardSchemeFactory());
  }
  ...
  static {
    ...
    tmpMap.put(_Fields.OLD_POSITION, new org.apache.thrift.meta_data.FieldMetaData("oldPosition", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.NEW_POSITION, new org.apache.thrift.meta_data.FieldMetaData("newPosition", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MoveTemplateOp.class, metaDataMap);
  }

  public MoveTemplateOp() {
  }
   ...
   */
  public MoveTemplateOp(MoveTemplateOp other) {
  ...
  public MoveTemplateOp deepCopy() {
    return new MoveTemplateOp(this);
  }
  ...
  public MoveTemplateOp setTemplateId(String templateId) {
    this.templateId = templateId;
    return this;
  }
  ...
  public MoveTemplateOp setOldPosition(int oldPosition) {
    this.oldPosition = oldPosition;
    setOldPositionIsSet(true);
    return this;
  }
  ...
  public MoveTemplateOp setNewPosition(int newPosition) {
    this.newPosition = newPosition;
    setNewPositionIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MoveTemplateOp)
      return this.equals((MoveTemplateOp)that);
    return false;
  }

  public boolean equals(MoveTemplateOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MoveTemplateOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MoveTemplateOp(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'oldPosition' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'newPosition' because it's a primitive and you chose the non-beans generator.
  ...
  private static class MoveTemplateOpStandardSchemeFactory implements SchemeFactory {
    public MoveTemplateOpStandardScheme getScheme() {
      return new MoveTemplateOpStandardScheme();
    }
  }

  private static class MoveTemplateOpStandardScheme extends StandardScheme<MoveTemplateOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MoveTemplateOp struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetOldPosition()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'oldPosition' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetNewPosition()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'newPosition' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, MoveTemplateOp struct) throws org.apache.thrift.TException {
      struct.validate();
