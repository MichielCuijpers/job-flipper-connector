...
public class EditTemplateOp implements org.apache.thrift.TBase<EditTemplateOp, EditTemplateOp._Fields>, java.io.Serializable, Cloneable, Comparable<EditTemplateOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("EditTemplateOp");
  ...
  private static final org.apache.thrift.protocol.TField PLANNED_DATA_SHEET_IDS_FIELD_DESC = new org.apache.thrift.protocol.TField("plannedDataSheetIds", org.apache.thrift.protocol.TType.MAP, (short)20);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new EditTemplateOpStandardSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PLANNED_DATA_SHEET_IDS((short)20, "plannedDataSheetIds");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 2: // POSITION
          return POSITION;
        case 20: // PLANNED_DATA_SHEET_IDS
  ...
  private static final _Fields optionals[] = {_Fields.PLANNED_DATA_SHEET_IDS};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(EditTemplateOp.class, metaDataMap);
  }

  public EditTemplateOp() {
  }
   ...
   */
  public EditTemplateOp(EditTemplateOp other) {
    ...
    if (other.isSetPlannedDataSheetIds()) {
      Map<String,String> __this__plannedDataSheetIds = new HashMap<String,String>(other.plannedDataSheetIds.size());
      for (Map.Entry<String, String> other_element : other.plannedDataSheetIds.entrySet()) {

        String other_element_key = other_element.getKey();
        String other_element_value = other_element.getValue();

        String __this__plannedDataSheetIds_copy_key = other_element_key;

        String __this__plannedDataSheetIds_copy_value = other_element_value;

        __this__plannedDataSheetIds.put(__this__plannedDataSheetIds_copy_key, __this__plannedDataSheetIds_copy_value);
      }
      this.plannedDataSheetIds = __this__plannedDataSheetIds;
    }
  }

  public EditTemplateOp deepCopy() {
    return new EditTemplateOp(this);
  }
  ...
  public EditTemplateOp setTemplateId(String templateId) {
    this.templateId = templateId;
    return this;
  }
  ...
  public EditTemplateOp setPosition(int position) {
    this.position = position;
    setPositionIsSet(true);
    return this;
  }
  ...
  public EditTemplateOp setPlannedDataSheetIds(Map<String,String> plannedDataSheetIds) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof EditTemplateOp)
      return this.equals((EditTemplateOp)that);
    return false;
  }

  public boolean equals(EditTemplateOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(EditTemplateOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("EditTemplateOp(");
    boolean first = true;
  ...
  private static class EditTemplateOpStandardSchemeFactory implements SchemeFactory {
    public EditTemplateOpStandardScheme getScheme() {
      return new EditTemplateOpStandardScheme();
    }
  }

  private static class EditTemplateOpStandardScheme extends StandardScheme<EditTemplateOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, EditTemplateOp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.plannedDataSheetIds = new HashMap<String,String>(2*_map49.size);
                String _key50;
                String _val51;
                for (int _i52 = 0; _i52 < _map49.size; ++_i52)
                {
                  ...
                  struct.plannedDataSheetIds.put(_key50, _val51);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EditTemplateOp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.plannedDataSheetIds != null) {
        if (struct.isSetPlannedDataSheetIds()) {
          oprot.writeFieldBegin(PLANNED_DATA_SHEET_IDS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter53 : struct.plannedDataSheetIds.entrySet())
            {
