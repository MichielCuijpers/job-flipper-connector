...
public class StepCompleteOp implements org.apache.thrift.TBase<StepCompleteOp, StepCompleteOp._Fields>, java.io.Serializable, Cloneable, Comparable<StepCompleteOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StepCompleteOp");
  ...
  static {
    schemes.put(StandardScheme.class, new StepCompleteOpStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StepCompleteOp.class, metaDataMap);
  }

  public StepCompleteOp() {
  }
   ...
   */
  public StepCompleteOp(StepCompleteOp other) {
  ...
  public StepCompleteOp deepCopy() {
    return new StepCompleteOp(this);
  }
  ...
  public StepCompleteOp setJobStepId(String jobStepId) {
    this.jobStepId = jobStepId;
    return this;
  }
  ...
  public StepCompleteOp setStepId(String stepId) {
    this.stepId = stepId;
    return this;
  }
  ...
  public StepCompleteOp setIsComplete(boolean isComplete) {
    this.isComplete = isComplete;
    setIsCompleteIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StepCompleteOp)
      return this.equals((StepCompleteOp)that);
    return false;
  }

  public boolean equals(StepCompleteOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StepCompleteOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StepCompleteOp(");
    boolean first = true;
  ...
  private static class StepCompleteOpStandardSchemeFactory implements SchemeFactory {
    public StepCompleteOpStandardScheme getScheme() {
      return new StepCompleteOpStandardScheme();
    }
  }

  private static class StepCompleteOpStandardScheme extends StandardScheme<StepCompleteOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StepCompleteOp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StepCompleteOp struct) throws org.apache.thrift.TException {
      struct.validate();
