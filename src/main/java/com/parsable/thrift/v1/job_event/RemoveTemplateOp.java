...
public class RemoveTemplateOp implements org.apache.thrift.TBase<RemoveTemplateOp, RemoveTemplateOp._Fields>, java.io.Serializable, Cloneable, Comparable<RemoveTemplateOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RemoveTemplateOp");
  ...
  static {
    schemes.put(StandardScheme.class, new RemoveTemplateOpStandardSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RemoveTemplateOp.class, metaDataMap);
  }

  public RemoveTemplateOp() {
  }
   ...
   */
  public RemoveTemplateOp(RemoveTemplateOp other) {
  ...
  public RemoveTemplateOp deepCopy() {
    return new RemoveTemplateOp(this);
  }
  ...
  public RemoveTemplateOp setTemplateId(String templateId) {
    this.templateId = templateId;
    return this;
  }
  ...
  public RemoveTemplateOp setPosition(int position) {
    this.position = position;
    setPositionIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RemoveTemplateOp)
      return this.equals((RemoveTemplateOp)that);
    return false;
  }

  public boolean equals(RemoveTemplateOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RemoveTemplateOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RemoveTemplateOp(");
    boolean first = true;
  ...
  private static class RemoveTemplateOpStandardSchemeFactory implements SchemeFactory {
    public RemoveTemplateOpStandardScheme getScheme() {
      return new RemoveTemplateOpStandardScheme();
    }
  }

  private static class RemoveTemplateOpStandardScheme extends StandardScheme<RemoveTemplateOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RemoveTemplateOp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RemoveTemplateOp struct) throws org.apache.thrift.TException {
      struct.validate();
