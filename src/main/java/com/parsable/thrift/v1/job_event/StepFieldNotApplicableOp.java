...
public class StepFieldNotApplicableOp implements org.apache.thrift.TBase<StepFieldNotApplicableOp, StepFieldNotApplicableOp._Fields>, java.io.Serializable, Cloneable, Comparable<StepFieldNotApplicableOp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StepFieldNotApplicableOp");
  ...
  private static final org.apache.thrift.protocol.TField IS_NOT_APPLICABLE_FIELD_DESC = new org.apache.thrift.protocol.TField("isNotApplicable", org.apache.thrift.protocol.TType.BOOL, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new StepFieldNotApplicableOpStandardSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IS_NOT_APPLICABLE((short)4, "isNotApplicable");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StepFieldNotApplicableOp.class, metaDataMap);
  }

  public StepFieldNotApplicableOp() {
  }
   ...
   */
  public StepFieldNotApplicableOp(StepFieldNotApplicableOp other) {
  ...
  public StepFieldNotApplicableOp deepCopy() {
    return new StepFieldNotApplicableOp(this);
  }
  ...
  public StepFieldNotApplicableOp setJobStepId(String jobStepId) {
    this.jobStepId = jobStepId;
    return this;
  }
  ...
  public StepFieldNotApplicableOp setStepId(String stepId) {
    this.stepId = stepId;
    return this;
  }
  ...
  public StepFieldNotApplicableOp setFieldId(String fieldId) {
    this.fieldId = fieldId;
    return this;
  }
  ...
  public StepFieldNotApplicableOp setIsNotApplicable(boolean isNotApplicable) {
    this.isNotApplicable = isNotApplicable;
    setIsNotApplicableIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StepFieldNotApplicableOp)
      return this.equals((StepFieldNotApplicableOp)that);
    return false;
  }

  public boolean equals(StepFieldNotApplicableOp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StepFieldNotApplicableOp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StepFieldNotApplicableOp(");
    boolean first = true;
  ...
  private static class StepFieldNotApplicableOpStandardSchemeFactory implements SchemeFactory {
    public StepFieldNotApplicableOpStandardScheme getScheme() {
      return new StepFieldNotApplicableOpStandardScheme();
    }
  }

  private static class StepFieldNotApplicableOpStandardScheme extends StandardScheme<StepFieldNotApplicableOp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StepFieldNotApplicableOp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StepFieldNotApplicableOp struct) throws org.apache.thrift.TException {
      struct.validate();
